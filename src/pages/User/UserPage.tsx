...
export default function UserPage() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start mb-32 gap-10">
      <header className="w-full aspect-[5] flex flex-col gap-2 justify-center items-center shadow-sm">
        <div className="z-10 w-full max-w-[70.5rem] flex justify-start items-center gap-1">
