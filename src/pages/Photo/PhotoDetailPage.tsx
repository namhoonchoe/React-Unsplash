    ...
    return (
      <section className="relative mb-8 flex w-[90vw]  max-w-[1200px] flex-col items-center justify-start gap-4 ">
        ...
        <main className="flex w-full justify-center">
          {aspectRatio >= 1 ? (
            <div
              className="skeleton  w-[90%] max-w-[800px]  md:w-4/5"
              style={{
            ...
            <div
              className="skeleton w-[90%] max-w-[800px] md:w-1/2"
              style={{
                aspectRatio: aspectRatio,
              }}
            ></div>
    ...
    return (
      <section className="relative mb-8 flex w-[90vw]  max-w-[1200px]  flex-col items-center justify-start gap-4 ">
        ...
        <main className="flex w-full justify-center">
          {aspectRatio >= 1 ? (
            <div
              className="-z-10 w-[90%] max-w-[800px]  md:w-4/5"
              style={{
                aspectRatio: aspectRatio,
              }}
            >
            ...
            <div
              className="w-[90%] max-w-[800px] md:w-1/2"
              style={{
                aspectRatio: aspectRatio,
              }}
            >
        ...
        <footer className="flex w-full flex-col items-start justify-start gap-6 p-4">
          <section className="flex flex-wrap items-center justify-start gap-8 *:capitalize">
            <>
              {photo.views > 0 && (
                <div className="flex flex-col justify-start gap-1">
                  <p className="text-xs text-slate-400 sm:text-sm">views</p>
            ...
            <>
              {photo.downloads > 0 && (
                <div className="flex flex-col justify-start gap-1">
                  <p className="text-xs text-slate-400 sm:text-sm">downloads</p>
                  <p className="text-xs text-slate-600 sm:text-sm">
            ...
            <>
              {photo.topics && photo.topics.length > 0 && (
                <div className="flex flex-col justify-start gap-1">
                  <p className="text-xs text-slate-400 sm:text-sm ">topics</p>
